    ...
    >
      <Card className="p-5">
        <div className="flex items-start justify-between mb-3 gap-3">
          ...
          <Badge variant="outline" className="text-[10px] shrink-0">{t("dailySummary")}</Badge>
        </div>
        ...
        <div className="grid grid-cols-5 gap-2 mb-3">
          <div className="rounded-md bg-muted/50 p-2 text-center">
            ...
            <p className="text-[9px] text-muted-foreground">{t("scans")}</p>
          </div>
          <div className="rounded-md bg-muted/50 p-2 text-center">
            <p className="text-[10px] text-muted-foreground">·</p>
            <p className="mt-0.5 text-sm font-bold tabular-nums">{summary.routesMonitored}</p>
            <p className="text-[9px] text-muted-foreground">{t("routesMonitored")}</p>
          </div>
          <div className="rounded-md bg-emerald-500/10 p-2 text-center">
            ...
            <p className="text-[9px] text-muted-foreground">{t("newDeals")}</p>
          </div>
          <div className="rounded-md bg-sky-500/10 p-2 text-center">
            ...
            <p className="text-[9px] text-muted-foreground">{t("priceDrops")}</p>
          </div>
          <div className={cn("p-2 text-center rounded-md", summary.errors > 5 ? "bg-rose-500/10" : "bg-muted/50")}>
            ...
            <p className="text-[9px] text-muted-foreground">{t("errors")}</p>
          </div>
        </div>

        {summary.topDeals.length > 0 && (
          <div className="space-y-1 mb-3">
            <p className="text-xs font-medium text-muted-foreground">{t("topDeals")}</p>
        ...
        <details className="text-xs">
          ...
          <pre className="mt-2 whitespace-pre-wrap font-sans text-xs leading-relaxed bg-muted/30 rounded-md p-3 border" dir="auto">
{summary.body}
          </pre>
        </details>
      </Card>
